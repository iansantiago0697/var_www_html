...
//        if (_this.$tableHeaders.eq(i + 1).length === 0 || (_this.$tableHeaders.eq(i).attr('data-noresize') != null) || (_this.$tableHeaders.eq(i + 1).attr('data-noresize') != null)) {
        if (_this.$tableHeaders.eq(i + 1).length === 0 || (_this.$tableHeaders.eq(i).attr('data-noresize') != null) || (_this.$tableHeaders.eq(i + 1).attr('data-noresize') != null) || (_this.$tableHeaders.eq(i).attr('data-disable') != null)) {
// update ↑
          return;
        }
...
// add ↓
      if(this.$tableHeaders.eq(this.$tableHeaders.index($leftColumn)).attr('data-fix') != null){
        $leftColumn = this.$tableHeaders.eq(this.$tableHeaders.index($leftColumn) - 1);
      }
// add ↑
      widths = {
