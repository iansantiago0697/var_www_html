...
//	3. 拡張機能のhtml中でeowpfと同じドメインにあるhtmlをiframeで表示し、そのhtml中からおすすめ表示をキャンセル
//
...
var CRXR = (function() {
	var showDelay = 1500, //表示するまでの待ち時間(ms)
		...
		cookieDomain = '.alc.co.jp', //Cookieを保存するドメイン
		...
		CrxRecommend = function() { //表示用
			var recommendText = 'Google Chrome 拡張機能と連携してご利用いただけます！',
				recommendLink = {
					...
					href: 'https://eowpf.alc.co.jp/gotoProm.html?type=chrome_extension'
				},
				hideButtonText = '×',
				id = {
