...
(function(global) {
  ...
  mc.helpers.getUIImgUrl = function mc_getUIImgUrl(fileName) {
    ...
    if(typeof baseUrl === 'undefined' || !/^http/.test(baseUrl)) {
       ...
       * テスト環境のURLを返すように変更する。
       */
      baseUrl = document.location.protocol + '//eowpf.alc.co.jp/content/img/';
    }
  ...
  mc.templates.remark = [
    '<div class="remark">',
        '<a href="https://home.alc.co.jp/db/owa/sp_sacd_redir_pt?code=c_eowp_renewal_1" target="_blank"><strong>サイトリニューアルに伴う<br />「サービス一時停止」のお知らせ</strong></a><br />',
        '<hr style="margin:10px 0px;">',
        '<a href="https://shop.alc.co.jp/spg/cart/renewpass/form/-/" target="_blank">パスワードをお忘れの方はこちら</a><br />',
        '<hr style="margin:10px 0px;">',
        '<% if(window.name == "eowpfapp" || window.name == "eowpfapp_opt"){ %>',
