 ...
 * @author hagino3000 <https://twitter.com/hagino3000> (Takashi Nishibayashi)
 * @author alanjds <https://twitter.com/alanjds> (Alan Justino da Silva)
 *
 * A JSON-RPC 2.0 implementation for jQuery.
 * JSON-RPC is a stateless, light-weight remote procedure call (RPC) protocol.
 * Read more in the <https://www.jsonrpc.org/specification>
 */
(function($) {
    var rpcId = 1;
