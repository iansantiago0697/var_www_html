...
(function(global) {
  ...
  mc.helpers.getUIImgUrl = function mc_getUIImgUrl(fileName) {
    ...
    if(typeof baseUrl === 'undefined' || !/^http/.test(baseUrl)) {
       ...
       * テスト環境のURLを返すように変更する。
       */
      baseUrl = document.location.protocol + '//eowp.alc.co.jp/sp/content/img/';
    }
  ...
  mc.templates.remark = [
    ...
    '<div class="remark">',
        ...
        '<hr>',
        '<a href="https://home.alc.co.jp/db/owa/sp_sacd_redir_pt?code=o_eowp_sp_login_01" target="_blank">「英辞郎 on the WEB Pro」とは？</a>',
