...
var eowApp = function (c) {
    ...
    })(eowConfig.cdnUrl + "stylesheets/", "dict.css");
    var h = function (a, e) {
        ...
        b.navi && g.push('<div class="nav">', '<ul><li><a href="${homeUrl}" title="アルクのホームページ" id="alc_top"><img src="${resourceUrl}images/t_symbol.svg" width="57" height="23"></a></li>', '<li><div class="logo login" > <a href="https://eowp.alc.co.jp/login" onclick="ga(\'send\', \'event\', \'eowtop_p_login\', \'click\', \'https://eowp.alc.co.jp/login\');"id="eowtop_p_login"><img src="${resourceUrl}images/lo_pro.svg"></a></li>', '<li><div class="login"> <a href="https://eowpf.alc.co.jp" id="eowtop_f_login"><img src="${resourceUrl}images/lo_proLite.svg"></a></li>');
        b.navi && b.settingsButton && g.push('<li><a href="#" title="Settings" id="search_settings"><img src="${resourceUrl}images/search_settings.png" width="76" height="23"></a></li></ul>');
        b.navi && g.push("</div>");
        g.push('<form action="${rootUrl}search.html" method="get" id="search_form">', '<span id="input-with-clearbutton" class="clearable" >', '<input id="q" type="text" autocapitalize="off" autocorrect="off" autocomplete="off" placeholder="\u82f1\u8f9e\u90ce on the WEB" name="q" data-role="none"/>', '<span id="clearbutton"></span>', "</span>", '<div id="word_suggest"></div>',
            '<input type="submit" value="search" data-role="none"/>', "</form>");
        c.tmpl(g.join("\n"), {
            ...
            _renderResults: function (a) {
                ...
                if (0 === a.sum) {
                    ...
                    if (1 === a.pg && !a.gradable.isEmpty()) b.definitions[0].gradable =
                        a.gradable;
                    b.addInfeed = false;
                    if (eowConfig.defaults.adcount <= b.definitions.length) {
                        b.addInfeed = true;
                    }
...
$(function () {
    ...
    $.when(loaddeps).done(function () {
        ...
        $("#q").bind("focus",
            function () {
                window.scrollTo(0, $("#q").offset().top - 44)
            })
    })
