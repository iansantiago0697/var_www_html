function footer(option){
  ...
  if(window.name == 'eowpfapp'){
    ...
    '    <a href="https://eowp.alc.co.jp/info-business/" target="_blank" onClick="ga(\'send\', \'event\', \'eowf_pc_footerhojin\', \'click\', \'https://eowp.alc.co.jp/info-business/\');" id="eowf_pc_footerhojin">法人のお客様</a> ｜ ',
