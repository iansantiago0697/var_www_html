  ...
  element.innerHTML =
    ...
    '<div class="bg_box2" style="height: '+whole_h+'px;"><div class="modal">'+
      '<div class="right close">'+
        '<img onclick="close_popup('+ret+')" src="' + IMG_URI + 'bt_del.png" width="20" height="20" alt="閉じる" title="閉じる" />'+
      '</div>'+
...
$(function(){
    $('#window_fixed_word').exFlexFixed({ watchPosition : true, container : 'body'});
    $('#window_fixed_word_top').exFlexFixed({ container : 'body'});
});
...
function balloon() {
		...
		//SP用
		//検索履歴
		var sp_icon_history_hopup  = '<div class="fukidashi sp_icon_history_hopup" align="center"> <p class="closeBtn"> <img src="/content/img/tango_close.png" alt="閉じる" width="12" height="12" /> </p>';
		    sp_icon_history_hopup += '<p class="text">「検索履歴」は、検索語を最新50件まで保持し、そこから再検索できる機能です。<br />有料版「英辞郎 on the WEB Pro」でご利用いただけます。<br />この「Pro Lite」ではご利用いただけません。</p> <p class="btn"> <a href='+historyURL+' target="_blank"> <img src="/content/img/tango_btn.png" alt="有料版を申し込む" width="71" height="19" /></a></p></div>';
		$('.sp_icon_history_f').append(sp_icon_history_hopup);
		//音声再生(検索結果)
		var sp_sound_hopup  = '<div class="fukidashi sp_sound_hopup" align="center"> <p class="closeBtn"> <img src="/content/img/tango_close.png" alt="閉じる" width="12" height="12" /> </p>';
			sp_sound_hopup += '<p class="text">クリックするとその英単語の音声が再生されて、発音を確認できる機能です。<br /><sound_moji_small class="sound_hopup_small">スピーカーのマークは、音声が収録されている英単語のみに付与されています。</sound_moji_small><br />有料版「英辞郎 on the WEB Pro」でご利用いただけます。<br />この「Pro Lite」ではご利用いただけません。</p> <p class="btn"> <a href='+soundURL+' target="_blank"> <img src="/content/img/tango_btn.png" alt="有料版を申し込む" width="71" height="19" /></a></p></div>';
		$('.sp_sound_f').append(sp_sound_hopup);
		//単語へのタグ付与
		var sp_spacing_hopup  = '<div class="fukidashi sp_spacing_hopup" align="center"> <p class="closeBtn"> <img src="/content/img/tango_close.png" alt="閉じる" width="12" height="12" /> </p>';
			sp_spacing_hopup += '<p class="text">単語帳に登録した語句を分類するために、タグを付与したり外したりする機能です。<br />有料版「英辞郎 on the WEB Pro」でご利用いただけます。<br />この「Pro Lite」ではご利用いただけません。</p> <p class="btn"> <a href='+tangoURL+' target="_blank"> <img src="/content/img/tango_btn.png" alt="有料版を申し込む" width="71" height="19" /></a></p></div>';
		$('.sp_spacing_f').append(sp_spacing_hopup);
		//単語へのタグ管理ボタン
		var sp_manage_tag_hopup  = '<div class="fukidashi sp_manage_tag_hopup" align="center"> <p class="closeBtn"> <img src="/content/img/tango_close.png" alt="閉じる" width="12" height="12" /> </p>';
			sp_manage_tag_hopup += '<p class="text">単語帳に登録した語句をグループ分けするために、タグを設定する機能です。<br />有料版「英辞郎 on the WEB Pro」でご利用いただけます。<br />この「Pro Lite」ではご利用いただけません。</p> <p class="btn"> <a href='+tangoURL+' target="_blank"> <img src="/content/img/tango_btn.png" alt="有料版を申し込む" width="71" height="19" /></a></p></div>';
		$('.sp_manage_tag_f').append(sp_manage_tag_hopup);
